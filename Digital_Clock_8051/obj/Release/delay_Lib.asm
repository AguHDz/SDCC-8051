...
;------------------------------------------------------------
;	delay_Lib.c:7: void delay_x10_cycles(uint8_t x10cycles)
;	-----------------------------------------
...
;------------------------------------------------------------
;	delay_Lib.c:30: void delay_x100_cycles(uint8_t x100cycles)
;	-----------------------------------------
;	 function delay_x100_cycles
;	-----------------------------------------
_delay_x100_cycles:
;	delay_Lib.c:49: __endasm;
	mov	r7,dpl
	dec	r7
	mov	a, r7
	mov	r6,#44
...
;------------------------------------------------------------
;	delay_Lib.c:55: void delay_ms(uint16_t delayTimeMS)
;	-----------------------------------------
;	 function delay_ms
;	-----------------------------------------
_delay_ms:
;	delay_Lib.c:73: __endasm;
	mov	r3,dpl
	mov	r4,dph
	    delay_ms_lib_loop:
	dec	r3
	...
	orl	a,r4
	jz	delay_ms_lib_fin
;	delay_Lib.c:75: CALL_DELAY_MS;
	mov	dpl,#0x64
	lcall	_delay_x10_cycles
;	delay_Lib.c:80: __endasm;
