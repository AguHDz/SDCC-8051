      ...
      000000                         28 	.ds 8
                                     ...
                                     97 ;------------------------------------------------------------
                                     98 ;	delay_Lib.c:6: void delay_x10_cycles(uint8_t x10cycles)
                                     99 ;	-----------------------------------------
      ...
      00006F 22               [24]  123 	ret
                                    ...
                                    128 ;------------------------------------------------------------
                                    129 ;	delay_Lib.c:29: void delay_x100_cycles(uint8_t x100cycles)
                                    130 ;	-----------------------------------------
                                    131 ;	 function delay_x100_cycles
                                    132 ;	-----------------------------------------
      000070                        133 _delay_x100_cycles:
                                    134 ;	delay_Lib.c:48: __endasm;
      ...
      000082 22               [24]  150 	ret
                                    ...
                                    155 ;------------------------------------------------------------
                                    156 ;	delay_Lib.c:54: void delay_ms(uint16_t delayTimeMS)
                                    157 ;	-----------------------------------------
                                    158 ;	 function delay_ms
                                    159 ;	-----------------------------------------
      000083                        160 _delay_ms:
                                    161 ;	delay_Lib.c:72: __endasm;
