      ...
      000062                        324 00102$:
                                    325 ;	main.c:16: P1_0=0;
      000062 C2 90            [12]  326 	clr	_P1_0
                                    327 ;	main.c:17: delay(40000);
      000064 90 9C 40         [24]  328 	mov	dptr,#0x9c40
      000067 12 00 74         [24]  329 	lcall	_delay
                                    330 ;	main.c:18: P1_0=1;
      00006A D2 90            [12]  331 	setb	_P1_0
                                    332 ;	main.c:19: delay(40000);
      00006C 90 9C 40         [24]  333 	mov	dptr,#0x9c40
      00006F 12 00 74         [24]  334 	lcall	_delay
      000072 80 EE            [24]  335 	sjmp	00102$
                                    336 ;------------------------------------------------------------
                                    337 ;Allocation info for local variables in function 'delay'
                                    338 ;------------------------------------------------------------
                                    339 ;vueltas                   Allocated to registers r6 r7 
                                    340 ;contador                  Allocated to registers r4 r5 
                                    341 ;------------------------------------------------------------
                                    342 ;	main.c:25: void delay(unsigned int vueltas)
                                    343 ;	-----------------------------------------
                                    344 ;	 function delay
                                    345 ;	-----------------------------------------
      000074                        346 _delay:
      ...
      000076 AF 83            [24]  348 	mov	r7,dph
                                    349 ;	main.c:28: for(contador=0; contador<vueltas; contador++);
      000078 7C 00            [12]  350 	mov	r4,#0x00
      00007A 7D 00            [12]  351 	mov	r5,#0x00
      00007C                        352 00103$:
      00007C C3               [12]  353 	clr	c
      00007D EC               [12]  354 	mov	a,r4
      00007E 9E               [12]  355 	subb	a,r6
      00007F ED               [12]  356 	mov	a,r5
      000080 9F               [12]  357 	subb	a,r7
      000081 50 07            [24]  358 	jnc	00105$
      000083 0C               [12]  359 	inc	r4
      000084 BC 00 F5         [24]  360 	cjne	r4,#0x00,00103$
      000087 0D               [12]  361 	inc	r5
      000088 80 F2            [24]  362 	sjmp	00103$
      00008A                        363 00105$:
      00008A 22               [24]  364 	ret
                                    365 	.area CSEG    (CODE)
                                    366 	.area CONST   (CODE)
                                    367 	.area XINIT   (CODE)
